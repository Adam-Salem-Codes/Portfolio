...
import PopScroll from "./Pop-Scroll";
        ...
        <div className="h-full flex w-full">
          ...
          <div className="w-full h-full flex justify-center items-center">
            <Link
              ...
              href="https://github.com/Adam-Salem-Codes"
              target="_blank"
            >
              <svg
                role="img"
            ...
            <Link
              className="text-2xl text-white hover:text-blue-500 mx-2 dark:hover:fill-blue-500 dark:fill-white fill-black hover:fill-blue-500 duration-500 flex w-6 h-6"
              href="https://discord.com/users/546501209633062922"
              target="_blank"
            >
              <svg
                role="img"
